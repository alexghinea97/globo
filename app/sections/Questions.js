            ...
            <View style={StyleSheet.container}>
                { !this.state.selected && (
                    <View style={styles.container}>
                        <Text style={StyleSheet.questionText}>{this.props.question}</Text>
                ...
                { this.state.selected && this.state.correct && (
                    <View style={styles.correctContainer}>
                        ...
                        <Text style={styles.questionText}>{this.props.answer1}</Text>
                        <Text style={styles.questionText}>{this.props.answer2}</Text>
                        <Text style={styles.questionText}>{this.props.answer3}</Text>
                        <Text style={styles.questionText}>{this.props.answer4}</Text>
                        <Text style={styles.questionText}>Correct</Text>
                    </View>
                )}
                ...
                { this.state.selected && !this.state.correct && (
                    <View style={styles.wrongContainer}>
                        ...
                        <Text style={styles.questionText}>{this.props.answer3}</Text>
                        <Text style={styles.questionText}>{this.props.answer4}</Text>
                        <Text style={styles.questionText}>Incorrect</Text>
                    </View>
                )}
            </View>
        );
